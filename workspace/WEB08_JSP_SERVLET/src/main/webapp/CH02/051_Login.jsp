...
<body>
	...
	<!-- 
		...
		-> 전송된 아이디로 데이터베이스 검색 -> 검색 결과에 따라 로그인 실패 또는 성공을 경우의 수로 나눠서 프론트에서 표시
		...
		4. 보통 form 에서 action 에는 로그인 검증을 담당하는 서블릿을 지정합니다
		5. 서블릿은 웹용 클래스라고 생각해도 무방합니다
		
		6. 지금은 서블릿도 웹클래스도 학습하지 않은 상태라서 그 역할을 052_Login_do.jsp 파일이 하도록 하겠습니다.
		7. 데이터베이스도 아직 연동하기 전이니 유효한 아이디 / 비번은 scott/1234로 하겠습니다
	 -->
</body>
</html>