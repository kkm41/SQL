...
//19세 이하는 되돌아감. 19세 이상이면 통과페이지로 이동(20세 미만이므로 입장이 불가합니다 라는 경고)
//20세 미만일 때 "입장이 불가합니다"라는 alert창 표시하고 되돌아갑니다
...
if(age<20){
	...
	<!-- html head body 등이 없다고 해서 다른 테그를 사용하지 못하는게 아닙니다. 그들은 양식일 뿐 html 태그는
...
<%
	...
	// 이때 현재 페이지의 request 와 response 도 같이 이동합니다(forward 의 특징)
	...
	//현재 페이지의 request 객체의 수명은 forward 로 전달될 다음 페이지 까지 입니다.
