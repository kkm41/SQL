...
--substr 의 경우 자바의  substring처럼 시작번째부터 끝번째+1이 아니라
--시작 번째 부터 글자수를 나타냅니다. 위의 경우 2번째 글자부터 네글자 표시
...
insert into retlist(rentdate,numseq)values(sysdate,rent_seq.nextVal);
...
-- add_months() : 개월 수 더하기
select add_months(sysdate,20) from dual; --2025.12.26 
...
--12.3456 : 반올림 하려는 숫자   3 : 반올림하여 표시하고자하는 마지막 자리수