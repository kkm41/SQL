...
class Animal{
	...
	//멤버 메서드는 같은 클래스내의 private 멤버변수에 자유롭게 접근 가능합니다
	  ...
	  //멤버변수, 멤버메서드들은 필요한만큼 자유롭게 정의하여 사용할 수 있습니다 public void setName(String name) 
	  //{	  this.name = name; 
	//  } public void setAge(int age) 
	  //{ this.age = age;
	  
	  //} public String getName() { return this.name; } public int getAge() { return
	 // this.age; }
	 
	
	//위 4개의 메서드들을 getter/setter 라고 부릅니다
	//보통 멤버변수의 값을 저장하거나 얻기 위한 메서드인데, 그 목적만 있다면 메서드 이름이 반드시 위와 같지는 않아도 무방합니다
	//그러나 getter와 setter는 개발자가 호출하여 사용하기도 하지만
	//시스템이 또는 컴파일러가 사용하기도 하기 때문에 약속된 이름(get변수이름,set변수이름)을 사용하는 것이 일반적입니다
