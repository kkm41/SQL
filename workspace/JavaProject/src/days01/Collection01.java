...
// 리스트 클래스를 상속받은 ArrayList 또는 Vector의 사용빈도수가 가장 높습니다
// Map 클래스를 상속받은 HashTable 또는 HashMap 또한 못지 않게 사용 빈도수가 높고 중요하게 사용됩니다
...
public class Collection01 {
	...
	public static void main(String[] args) {
		...
		//Vector와 ArrayList 저장은 int형이 아닌 Integer형 객체가 저장됩니다.
