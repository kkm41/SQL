...
public class ClassThis01 {
	public static void main(String[] args) {
		...
		c2.init(10); // 10-> init 메서드의 매개변수 n으로   c1은 init 메서드의 this로 전달
		c3.init(10); // 10-> init 메서드의 매개변수 n으로   c1은 init 메서드의 this로 전달
		...
		c3.setNum(100);
		System.out.println(c4.getNum()); //100
		System.out.println(c3.getNum()); //30
	}
